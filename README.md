...
| `BA_CODEX_MODEL` | _(optional - fallback)_ | Codex model for Business Analyst workflow. **Prefer** setting `params.baModel` in `config/workflows/ai-teammate/ai-teammate.config` instead. |
