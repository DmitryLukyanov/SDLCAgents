...
- One assumption documented for clarification if needed: angle unit for sine (radians assumed by default; degrees are an alternative if stakeholders prefer).
